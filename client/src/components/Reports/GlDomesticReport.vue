                ...
                for(const usr of this.advisors){
                    ...
                    for(const tr of this.grouped[usr.uniqueNumber].transactions){
                        ...
                        if(tr.paymentType === 'Cash'){
                            this.grouped[usr.uniqueNumber].cash = this.grouped[usr.uniqueNumber].cash + ((tr.amount / tr.conversionRate)) + ((tr.taxLocal / tr.conversionRate))
                        } else {
                            this.grouped[usr.uniqueNumber].card = this.grouped[usr.uniqueNumber].card + ((tr.amount / tr.conversionRate)) + ((tr.taxLocal / tr.conversionRate))
                        }

                        this.grouped[usr.uniqueNumber].tax = this.grouped[usr.uniqueNumber].tax + ((tr.taxLocal / tr.conversionRate))

                        this.grouped[usr.uniqueNumber].totalP = this.grouped[usr.uniqueNumber].totalP + ((tr.taxLocal / tr.conversionRate)) + ((tr.amount / tr.conversionRate))
